...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    if(empty(trim($_POST['company'])))
      {
        $cp_err = "Please Enter Valid First Name";
      } 
      else
      {
        $cp = mysqli_real_escape_string($conn,$_POST["company"]);
      }
      ...
      {
        $job_err = "Please Enter valid number";
      } 
      else
      {
        $job = mysqli_real_escape_string($conn,$_POST["job"]);
      }
      if(empty(trim($_POST['pos'])))
      {
        $pos_err = "Please Enter Valid Email";
      } 
      else
      {
      ...
      $q="insert into logs(name,page,action) values('$cp','Skills','Edited')";
            mysqli_query($conn, $q);
...
<?php }?>
        ...
        <section style="align-content: center;align-self:center; margin-left: 20px">
            ...
            <?php 
            $sql = "SELECT * FROM experience where id='$ed'";
            ...
            <input type="text" style="float: left; margin-left: 40px" name="company" value="<?php echo $row['company_name']?>" required/>
            <div>
            ...
            <input type="text" style="float: left;margin-left: 50px" name="job" value="<?php echo $row['job_type']?>" required/>
            <div>
            ...
            <input type="text" style="float: left;margin-left: 50px" name="pos" value="<?php echo $row['pos']?>" required/>
            <div>
                                                <span class="help-block" style="color:red;font-size:small" id="cperr" name="cperr"><?php echo $pos_err; ?></span>
																								</div>
            <br>
            <label style="float: left">Description</label>
            <textarea name="des" value="<?php echo $row['description']?>" style="float:left; margin-left:30px"><?php echo $row['description']?></textarea>
            <div>
