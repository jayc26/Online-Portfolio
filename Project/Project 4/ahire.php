...
<?php }?>
        ...
        <section style="margin-left: 70px;margin-top: 50px;">
           ...
           <a href="addh.php"> <button style="float:right; margin-right:100px">Add</button></a>
            </p>
        </br>
        <br>
        </section>
        ...
        <form method="post">
                    ...
                    <button style="float:right; margin-right:50px;" name="Delh" Onclick="delh('<?php echo $row['jid']?>'); return false;">Delete</button>
                    </form>
